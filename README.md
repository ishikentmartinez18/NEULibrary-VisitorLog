...
### 🔐 Admins
- Secure Google login restricted to NEU accounts
- Real-time stats — today, this week, this month, all-time
- Filter and search visit logs by name, reason, date range, or visitor type
- Block or unblock specific visitors from library access
- Export visit logs and visitor summaries as **PDF**
- Auto-refreshes every 10 seconds

## 🛠️ Built With
- **PHP** — backend & session handling
- **MySQL** — data storage
...
## 👨‍💻 Developer
**Ishi Kent Martinez** — BSIT, New Era University
